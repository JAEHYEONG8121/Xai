...
class DataLoader():
    ...
    def preprocess_data(self):
        # Convert boolean-like values (True/False) to integers (1/0)
        self.data.replace({True: 1, False: 0}, inplace=True)
        ...
        # Convert boolean-like values (True/False) to integers (1/0) after one-hot encoding
